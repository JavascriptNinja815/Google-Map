...
?>
<form class="form-horizontal" id="cc-void-form" action="<?php print BASE_URI;?>/dashboard/creditcard/transaction/void">
	...
	<h2>Void Transaction # <?php print htmlentities($_POST['transaction_id']);?></h2>
	...
	<div class="control-group">
		<div class="controls">
			<button type="submit" class="btn btn-primary">Submit Void</button>
		</div>
	</div>
</form>

<script type="text/javascript">
	$(document).off('submit', '#cc-void-form');
	$(document).on('submit', '#cc-void-form', function(event) {
		var form = this;
		var $form = $(form);
