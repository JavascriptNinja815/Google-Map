...
<form id="kill-feedback-form" class="form-horizontal" method="post" action="<?php print BASE_URI; ?>/dashboard/account/feedback/submit">
...
<script type="text/javascript">
	...
	$(document).off('submit', '#kill-feedback-form')
	$(document).on('submit', '#kill-feedback-form', function(e){
		...
		$.ajax({
			...
			'success': function(rsp) {
				var msg = '<div style="padding:24px;">Feedback successfully killed.</div>'
