...
$args = array(
	'title' => 'Hot Orders',
	'breadcrumbs' => array(
		'Orders' => BASE_URI . '/dashboard/sales-orders/hot',
		'Hot' => BASE_URI . '/dashboard/sales-orders/hot'
	)
);
...
<div class="padded">
	<fieldset>
		<legend>
			Hot Orders
			<span style="font-size:12px;font-style:italic;line-height:21px;vertical-align:middle;font-weight:normal;display:inline-block;padding-left:20px;" id="hot-datetime"></span>
		</legend>
	...
	$(function() {
		...
		var loadOrders = function() {
			$.each(containers, function(request_type, request) {
				...
				$.ajax({
					'url': BASE_URI + '/dashboard/sales-orders/hot/retrieve',
					'data': {
						'type': request_type
					},
					'dataType': 'json',
					'success': function(data) {
						...
						// Populate hot data.
						$.each(data['hot'], function(index, record) {
