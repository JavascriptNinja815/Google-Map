...
/*
 * Modifictions and class encapsulation by:
 * 
...
class Barcde {
	...
	public static $ORIENTATION_HORIZONTAL = 0;
	public static $ORIENTATION_VERTICAL = 1;

	// Constants: Format
	public static $FORMAT_CODE128 = 0;
	public static $FORMAT_CODE39 = 1;
	public static $FORMAT_CODE25 = 2;
	public static $FORMAT_CODABAR = 3;

	/**
	 * @param type $format Valid formats: `code128`, `code39`, `code25` and `codabar`
	 */
	function __construct($format = 'code128') {
